...
// The length property is a numeric value and should not fall below 0. It should not throw any errors, but if an attempt to 
// decrease it below 0 is done, it should be automatically set to 0.
