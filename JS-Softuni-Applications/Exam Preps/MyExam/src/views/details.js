...
const detailsTemplate = (isCreator, data, onDelete, isUser, bookTotalLikes, likeBook, userAlreadyLiked) => html`
<section id="details-page" class="details">
    <div class="book-information">
        ...
        <div class="actions">
            ...
            ${!isCreator && isUser && !userAlreadyLiked ? html`<a @click=${likeBook} class="button"
...
export async function detailsPage(ctx) {
    ...
    ctx.render(detailsTemplate(isCreator, book, onDelete, isUser, bookTotalLikes, likeBook, userAlreadyLiked));
