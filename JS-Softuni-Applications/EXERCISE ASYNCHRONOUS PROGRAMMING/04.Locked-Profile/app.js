...
function makeProfile(age, email, username, id) {
    ...
    const input3 = el('input', undefined, undefined, undefined, undefined, 'text', 'user1Username', `${username}`, ['disabled', 'readonly']);
    const div2 = el('div', undefined, undefined, "user1HiddenFields");
    const hr2 = el('hr');
    const label4 = el('label', 'Email:');
    const input4 = el('input', undefined, undefined, undefined, undefined, 'email', 'user1Email', `${email}`, ['disabled', 'readonly']);
    const label5 = el('label', 'Age:');
    const input5 = el('input', undefined, undefined, undefined, undefined, 'email', 'user1Age', `${age}`, ['disabled', 'readonly']);
