...
// We declare a state obj with default falue obj to store the 3 components later.
// And we make it visible to the whole global scope which is not recommended.
let state = {
    obj: []
};
attachEvents();
...
async function getWeather() {
    ...
    // these 2 requests are independent so we can call them both in the same time. 
    ...
    // we invoke these 3 functions for the three day cast append.
